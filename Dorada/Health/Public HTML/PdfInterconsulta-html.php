<?php
	...
	$strConsulta = "SELECT * from hlt_interconsulta where caso =  '$caso'";
	...
	<fieldset>
		...
		<label>Atencion: Agudeza Visual</label><br>	
	...
	<br>
	<fieldset>
		<legend>II. INFORMACIÓN PARA LA INTERCONSULTA</legend>
		<label>fecha_solicitud'.$psic['fecha_solicitud'].'</label><br>	
		<label>origen'.$psic['origen'].'</label><br>	
		<label>destino'.$psic['destino'].'</label><br>	
		<label>resumen_historia'.$psic['resumen_historia'].'</label><br>	
		<label>tratamiento'.$psic['tratamiento'].'</label><br>	
		<label>analisis'.$psic['analisis'].'</label><br>	
		<label>dx1'.$psic['dx1'].'</label><br>	
		<label>dx2'.$psic['dx2'].'</label><br>	
		<label>dx3'.$psic['dx3'].'</label><br>	
		<label>dx4'.$psic['dx4'].'</label><br>	
	</fieldset>
	<br>
	</body>
	</html>';
