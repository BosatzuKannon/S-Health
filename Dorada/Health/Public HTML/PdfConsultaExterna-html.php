<?php
	...
	$strConsulta = "SELECT * from hlt_consulta_externa where caso =  '$caso'";
	...
	if (file_exists('datosxml/ConsultaExternaXml.xml')) {
    $xml = simplexml_load_file('datosxml/ConsultaExternaXml.xml');
	...
	<fieldset>
		...
		<label>Atencion: Consulta  Externa</label><br>	
	...
	<br>
	<fieldset>
		<legend>IV. Factores de riesgo</legend>
	...
	<br>
	<fieldset>
		<legend>V. Examen fisico</legend>
		<label>PA: '.$psic['exa_pa'].'</label>
		<label>FC: '.$psic['exa_fc'].'</label>
		<label>P: '.$psic['exa_p'].'</label>
		<label>FR: '.$psic['exa_fr'].'</label><br>
		<label>T: '.$psic['exa_temp'].' °C</label>
		<label>Sat: '.$psic['exa_sat'].'</label>
		<label>Eg: '.$psic['exa_eg'].'</label>
		<label>Peso: '.$psic['exa_peso'].' Kg</label><br>
		<label>Talla: '.$psic['exa_talla'].' Cm</label>
		...
		<label>Neurologico: '.$psic['exa_neurologico'].'</label> <br>
		<label>Piel y faneras'.$psic['exa_piel'].'</label><br>
		<label>Tratamiento y conducta: '.$psic['tratamiento'].'</label>
	</fieldset>
	<br>
	</body>
	</html>';
