<?php
	...
	$strConsulta = "SELECT * from hlt_atencion_alteraciones_embarazo where caso =  '$caso'";
	...
	<fieldset>
		...
		<label>Atencion: Atelraciones de embarazo</label><br>	
	...
	<fieldset>
		...
		<label>Peso: '.$psic['txt_peso_madre'].'</label><br>
		<label>Talla: '.$psic['txt_talla_madre'].'</label><br>
		...
		<label>Edad gestacional: '.$psic['txt_edad_gestacional'].'</label><br>
	</fieldset>
	<fieldset>
		<legend>IV. Antecedentes obstetricos </legend>
		<label># Gestaciones: '.$psic['txt_gestaciones'].'</label>
		<label># Partos: '.$psic['txt_partos'].'</label>
		<label># Cesareas: '.$psic['txt_cesareas'].'</label>
		<label># Abortos: '.$psic['txt_abortos'].'</label><br>
		<label># Espontaneos: '.$psic['txt_espontaneo'].'</label> 
		<label># Provocados: '.$psic['txt_provocado'].'</label><br>
		<label># Muerto en 1ra sem: '.$psic['txt_hijo_muerto'].'</label>
		<label># Hijos prematuros: '.$psic['txt_hijos_prematuros'].'</label>
		<label># Hijos <2500gr: '.$psic['txt_hijos_2500'].'</label> <br>
		<label># Hijos >4000gr: '.$psic['txt_hijos_4000'].'</label>
		<label># Malformados: '.$psic['txt_hijo_malformado'].'</label>
		<label># Hipertension: '.$xml->DRP_HIPERTENSION->es->option[intval($psic['drp_hipertension'])].'</label>
		<label># Preeclampsia: '.$xml->DRP_PREECLAMSIA->es->option[intval($psic['drp_preeclamsia'])].'</label>
		<label># Eclampsia: '.$xml->DRP_ECLAMPSIA->es->option[intval($psic['drp_eclampsia'])].'</label><br>
		<label># Fecha ultimo parto: '.$psic['date_ultimo_parto'].'</label>
	...
	<fieldset>
		...
		<label>Observaciones: '.$psic['area_observaciones_gest'].'</label>
	</fieldset>
	<fieldset>
	...
	<fieldset>
		<legend>VII. Observaciones complementarias </legend>
